...
const ServiceGrid = () => {
  ...
  const servicesData = [
    ...
    },
    {
      ...
      title: "REPORT SCAM",
      onClick: () => triggerInfoCollection(ProductTyping.SCAM_ALERT),
    },
    {
      ...
      title: "SUPPORT",
      onClick: () => triggerInfoCollection(ProductTyping.POST_VISA_DENIAL),
    },
    {
      ...
      onClick: () => triggerInfoCollection(ProductTyping.CONSULTATION),
    },
    {
      ...
      onClick: () => triggerInfoCollection(ProductTyping.DIASPORA_PROJECT),
    },
    {
      ...
      onClick: () => triggerInfoCollection(ProductTyping.POST_RELOCATION),
    },
  ];
