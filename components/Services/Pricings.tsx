...
const Pricings = ({ 
  ...
  return (
    <motion.section
      ...
      className="flex w-full flex-col justify-center items-center gap-[30px] shrink-0 bg-neutral-variant-95 py-2.5"
    >
          ...
          >
            ...
            <div className="flex h-[394px] flex-col justify-between items-center shrink-0 self-stretch px-2.5 py-10">
              ...
              <p className="font-montserrat text-display-large text-black font-bold">
                ${Item.price}
                <span className="text-headline-medium font-medium">/month</span>
              </p>
            </div>
