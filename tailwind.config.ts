...
const config: Config = {
    ...
    extend: {
      colors: {
        ...
        error: {
          ...
          on: colors.error.on_error,
          container: colors.error.error_container,
          on_container: colors.error.on_error_container,
        },
        success: {
          ...colors.success,
          base: colors.success.base,
          on: colors.success.on_success,
          container: colors.success.success_container,
          on_container: colors.success.on_success_container,
        },
  ...
  plugins: [addVariablesForColors, require("tailwind-scrollbar-hide"), require('@tailwindcss/typography'),],
};
