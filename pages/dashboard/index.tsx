    ...
    <div className="min-h-screen font-montserrat">
      ...
      <div className="py-6 flex items-center mx-6">
        <p className="text-body-large">
          Terms and conditions apply. NaijaSpora is not a visa-issuing body and does not guarantee
          approval. All trademarks, logos, and brand names are property of their respective owners.
        </p>
        <RiMessage2Fill
          size={40}
          className="ml-4 "
